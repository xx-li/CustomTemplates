...
final class ___VARIABLE_moduleName___ViewController: DTBaseViewController {
    ...
    func requestDelete(model: ___VARIABLE_moduleName___Model) {
        ...
        engine.requestOperationList(behaviorType: .delete, model: model) {[weak self] (isSuccess, msg) -> (Void) in
            guard let self = self else { return }
    ...
    @objc func datasDidChange(_ notification: Notification) {
        ...
        self.syncTableView(for: behavior)
    }


    // MARK: - UI -

    func syncTableView(for behavior: ___VARIABLE_moduleName___Engine.ChangeBehavior) {
        switch behavior {
